...
insert into empleado(id,usuario,password,rol, activo, dni, nombre, apellido1, apellido2, fechaNacimiento, telefono, email, jefe, empresa_id) values (17,'test','123456','u', 1, '99988889X', 'User', 'Testing', 'Helloworld', '2009-10-01', '943333333','a@es.com', 16 ,4);
