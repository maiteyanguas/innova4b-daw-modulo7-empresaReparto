...
insert into coche(id, combustible, kms, marca, matricula, modelo, empresa_id) values (1, 'gasolina', 12345, 'ford', '1234www', 'kuga', 1);
insert into coche(id, combustible, kms, marca, matricula, modelo, empresa_id) values (2, 'gasolina', 12345, 'ford', '6748ABC', 'kuga',2);
insert into coche(id, combustible, kms, marca, matricula, modelo, empresa_id) values (3, 'gasolina', 12345, 'ford', '6683KJU', 'kuga',3);
insert into coche(id, combustible, kms, marca, matricula, modelo, empresa_id) values (4, 'diesel', 12345, 'ford', '7835IYT', 'kuga',4);
insert into coche(id, combustible, kms, marca, matricula, modelo, empresa_id) values (5, 'diesel', 12345, 'ford', '3468TTY', 'kuga',4);
